...
import img from '../programming/2.png';
import{
  Link as ScrollLink,
  Element,
  Events,
...
export const PApp=()=> {
  ...
  const handleLoginClick = () => {
    navigate("/clubs/programming/admin-dashboard");
  };
    ...
    <div>
      <nav className="navbar">
        <ul className="navbar-menu">
          <li>
          {(Admin==="true") ?  (<button className="butt" onClick={handleLoginClick}>
              Add Event
            </button>):(<></>)}
